...
const I18N = {
  en: {
    ...
    grounding:
      "Powered by verified PromptWars data — delivering precise, hallucination-free stadium guidance.",
  },
  es: {
    language: "Idioma",
    ...
    grounding:
      "Impulsado por datos verificados de PromptWars: ofreciendo orientación precisa y sin alucinaciones en el estadio.",
  },
  fr: {
    language: "Langue",
    ...
    grounding:
      "Propulsé par des données PromptWars vérifiées — offrant un guidage précis et sans hallucination dans le stade.",
  },
};
